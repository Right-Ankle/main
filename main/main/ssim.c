...
double b_SSIM(double data1[][8], double data2[][8], int width, int height) {

    double c1 = pow(0.01 * 255, 2);
    double c2 = pow(0.03 * 255, 2);
    double data1_temp[8 * 8];
    double data2_temp[8 * 8];
    ...
    for (a = 0; a < 8; a++)
        for (b = 0; b < 8; b++) {
            data1_temp[a * 8 + b] = (double)data1[a][b];
            data2_temp[a * 8 + b] = (double)data2[a][b];
        }
